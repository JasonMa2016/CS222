...
import sys
from model_size import SizeEstimator
...
CNN = CNN()
trainNet(CNN, train_loader, val_loader, batch_size=30, n_epochs=1, learning_rate=0.01)
...
se = SizeEstimator(CNN)
print("CNN size:", se.estimate_size())
...
print("Bloom Filter size:", BF.size / 8)
print("Total size", model_size + BF.size/8)
